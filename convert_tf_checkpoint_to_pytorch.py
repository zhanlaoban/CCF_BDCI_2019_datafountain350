...
python convert_tf_checkpoint_to_pytorch.py \
    ...
    --bert_config_file ./pretrained_model/xlnet_large/XLNet_zh_Large_L-24_H-1024_A-16/xlnet_config.json \
    --pytorch_dump_path ../pretrained_model/xlnet_large/pytorch_model.bin \
"""