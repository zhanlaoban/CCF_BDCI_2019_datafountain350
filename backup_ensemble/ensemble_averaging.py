...
#model_prefix = 'sub_09_18_roberta_large/model_roberta_large'
#out_path = './model_result/sub_robert_large.csv'
...
#后续增加模型时，必须进行说明具体增加了哪个模型

#model_prefix = './result/bert_base/bert_base'
#out_path = './result/bert_base'

#10_11_1 求平均
#models = ['backup1_ERNIE_base', 'backup5_roberta_large', 'backup2_bert_base']
